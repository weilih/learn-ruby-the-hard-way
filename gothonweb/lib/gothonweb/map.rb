module Map
  ...
  """
  The Gothons of Planet Precal #25 have invaded your ship and destroyed
  your entire crew. You are the last surviving member and your last mission is
  to get the neutron desctruct bomb from the Weapons Armory, put it in the
  bridge, and blow the ship up after getting into an escape pod.

  You're running down then cenral corridor to the Weapons Armory when a Gothons
  jumps out, red scaly skin, dark grimy teeth, and evil clown costume flowing
  around his hate filled body.
  ...
  """
  Lukcy for you they made you learn Gothon insults in the academy.
  You tell the one Gothon joke you know:
  Lbhe zbgure vf fb sng, jura fur fvgf nebqhaq gur gbhrf, fur fvgf nebhq gur ubnfr.
  The Gothon stops, tries not to laugh, then busts out laughing can't move.
  ...
  Gothons that might be hiding. It's dead quiet, too quiet.
  You stand up and run to the far side of the room and find the neutron bomb in
  its container. There's a keypad lock on the box and you need the code to get
  the bomb out. If you get the code wrong 10 times then the lock closes forever
  ...
  You grab the neutron bomb and run as fast you can to the bridge where you must
  place it in the right spot.

  You burst onto the Bridge with the neutron destruct bomb under your arm and
  surprises 5 Gothons who are trying to take control of the ship. Each of them
  ...
  """
  You point you blaster at the bomb under your arm and the Gothons put their
  hands up and start to sweat.
  You inch backward to the door, open it, and then carefully place the bomb on
  the floor, pointing your blaster at it.
  ...
  escape pods, and now need to pick one to take. Some fo the could be damaged
  ...
  As it flies to the planet, you look back and see your ship implodes then
  ...
  # bad people on the internet can't access random variables with names.
  # You cant use Test::constants and Kernal.const_get too.
